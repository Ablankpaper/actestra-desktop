...
const FAILURE_STAGE_CODES = Object.freeze({
  ...
  "parent-death-runner-group-malformed": "integration-parent-death-runner-group-malformed-failed",
  ...
  "parent-death-model-owner-not-listed": "integration-parent-death-model-owner-not-listed-failed",
