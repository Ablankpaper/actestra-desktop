...
if (probeSourceRelativePath === undefined) {
  process.stderr.write("Goose containment target-unsupported\n");
  process.exitCode = 2;
} else {
  ...
  const probeSource = await readFile(path.join(repositoryRoot, probeSourceRelativePath));
