...
const FAILURE_STAGE_CODES = Object.freeze({
  ...
  "windows-worker-capability-pipe-busy": "windows-runtime-worker-capability-pipe-busy",
  ...
  "windows-worker-model-pipe-access-denied": "windows-runtime-worker-model-pipe-access-denied",
  "windows-worker-model-pipe-busy": "windows-runtime-worker-model-pipe-busy",
  "windows-worker-model-pipe-unavailable": "windows-runtime-worker-model-pipe-unavailable",
  "windows-worker-model-pipe-unclassified": "windows-runtime-worker-model-pipe-unclassified",
