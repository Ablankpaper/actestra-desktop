...
async function main(): Promise<never> {
  if (
    ...
    throw new Error("native Linux supervisor fixture is unavailable");
  }
  ...
  if (manifestSha256 === undefined || fixtureRoot === undefined || statePath === undefined) {
    throw new Error("native Linux supervisor fixture configuration is invalid");
  }
