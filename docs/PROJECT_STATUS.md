...
license/NOTICE/SBOM/`pip-audit`, cross-platform packaging, scheduler execution,
mixed General+Goose work, Team UI, or P6 completion. The production planner
provider remains unavailable until every ADR-0015 admission gate is satisfied.
...
8. Preserve P5.3 exact head `15a8e29b44a6684313f29a694f0d0615de95cf36`,
   ...
   preservation.
9. Keep schema-14 admitted-plan authority, schema-15 Team run authority, and the
   generic non-authoritative planner protocol/supervisor in the same unpushed P6
   batch, then add the Actestra-owned scheduler before admitting any real
   CrewAI provider. Deliver the user-visible AionUI-native
