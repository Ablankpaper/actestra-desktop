...
2. Add representative file, local research, writing, office-document, and
   schedule journeys while retaining the preserved AionUI surface and
   Actestra-owned authority.
3. Complete representative tool-failure, Worker-crash, and Artifact-conflict
   evidence in addition to the accepted denial, cancellation, persistence, and
   restart paths.
