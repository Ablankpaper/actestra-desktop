...
`/Users/zizimutou/actestra-worktrees/p8-stabilization-current` on branch
`codex/release/p8-stabilization-current`. This worktree was created directly
from `origin/main`; it is not the older local checkout at `e8074b73…`, and it
does not replace the existing WIP worktree at
`/Users/zizimutou/actestra-worktrees/p8-stabilization`.
