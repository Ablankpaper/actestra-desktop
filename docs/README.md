...
| [P7 Worker Resource and Process Reliability](architecture/decisions/0028-p7-worker-resource-and-process-reliability.md) | Fixed General/Goose profiles, closed resource incidents, existing enforcement authorities, rollback, and P8 non-claims |
| [P7 Diagnostic Export and Audit Retention](architecture/decisions/0029-p7-diagnostic-export-and-audit-retention.md)     | Explicit-consent local metadata export, schema-23 audit-chain retention, rollback, and P8 non-claims                    |
