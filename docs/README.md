...
| [P8 Cross-Platform Internal Beta](product/P8_CROSS_PLATFORM_INTERNAL_BETA.md)                                         | Exact initial target matrix, staged acceptance evidence, failure vocabulary, and non-claims                              |
| [P8.4 Internal-Beta Runbook](acceptance/P8.4_INTERNAL_BETA_RUNBOOK.md)                                                | Clean-machine lifecycle, real-provider, redacted evidence, and issue-intake procedure                                |
...
| [Security Threat Model](security/THREAT_MODEL.md)                                                                      | Repository-scoped P7 assets, trust boundaries, invariants, attacker stories, severity, and evidence rules               |
| [P7 Abuse-Case Ledger](security/P7_ABUSE_CASES.md)                                                                     | Stable P7.1 attack IDs, expected boundaries, forbidden effects, dispositions, and P8 obligations                        |
...
| [P7 Threat Model and Abuse Authority](architecture/decisions/0027-p7-threat-model-and-abuse-authority.md)              | Stable security invariant and attack IDs, closed outcomes, staged P7 authority, and P8 obligations                      |
| [P7 Worker Resource & Process Reliability](architecture/decisions/0028-p7-worker-resource-and-process-reliability.md)  | Fixed General/Goose profiles, closed resource incidents, existing enforcement authorities, rollback, and P8 non-claims  |
| [P7 Diagnostic Export & Audit Retention](architecture/decisions/0029-p7-diagnostic-export-and-audit-retention.md)      | Explicit-consent local metadata export, schema-23 audit-chain retention, rollback, and P8 non-claims                    |
| [P8 Cross-Platform Internal Beta Acceptance](architecture/decisions/0030-p8-cross-platform-internal-beta-acceptance.md) | Exact target matrix, staged evidence, failure vocabulary, and P8.1 non-claims                                           |
